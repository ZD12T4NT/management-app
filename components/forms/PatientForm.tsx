...
const PatientForm = () => {
  ...
  return (
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 flex-1">
        ...
        <CustomFormField fieldType={FormFieldType.INPUT} control={form.control} name="name" label="name" placeholder="John Doe" iconSrc="/assets/icons/user.svg" iconAlt="user" />
